...
<canvas id="chart1" style="width:100%; background:yellow;" height="500%"></canvas>
<script>
...
<canvas id="chart2" style="width:100%; background:pink;" height="500%"></canvas>
<script>
...
<canvas id="chart3" style="width:100%; background:#4ECB52" height="500%"></canvas>
<script>
...
<canvas id="chart4" style="width:100%; background:#FF0C82;" height="500%"></canvas>
<script>
